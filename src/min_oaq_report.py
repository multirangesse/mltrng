...
def random_oaquery_d1min_sample(max_dim,d_range = 5):
...
def random_oaquery_d2min_sample(max_dim,d_range = 5):
    width_min = np.random.randint(1,d_range+1)
    width_max = np.random.randint(max_dim-d_range,max_dim)
...
def random_oaquery_d3min_sample(max_dim,d_range = 5):
    width_min = np.random.randint(1,d_range+1)
    width_max = np.random.randint(max_dim-d_range,max_dim)
    rn1 = random_range_calc(width_max, max_dim)
    rn2 = random_range_calc(width_max, max_dim)
...
def random_oaquery_d4min_sample(max_dim,d1_range = 5):
    width_min = np.random.randint(1,d1_range+1)
    width_max = np.random.randint(max_dim-d1_range,max_dim)
    rn1 = random_range_calc(width_max, max_dim)
    rn2 = random_range_calc(width_max, max_dim)
    rn3 = random_range_calc(width_max, max_dim)
...
sample_num = 100
max_dim = 32
range_list = [random_oaquery_d1min_sample(max_dim) for i in range(sample_num)]
...
while len(range_list)<sample_num:
    ...
    for i in range(sample_diff):
        range_list.append( random_oaquery_d1min_sample(max_dim) )
